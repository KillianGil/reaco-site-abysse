        ...
        <main ref={containerRef} className="min-h-screen bg-[#020A19] text-white selection:bg-[#4CBBD5] selection:text-[#020A19] overflow-x-hidden">
            ...
            <section className="relative h-[50vh] md:h-[60vh] flex flex-col justify-center items-center text-center px-4 md:px-6 z-10">
                ...
                <div className="relative z-10 space-y-4 md:space-y-6 max-w-4xl">
                    ...
                    <p className="hero-title text-base md:text-xl text-white/70 max-w-2xl mx-auto">
            ...
            <div className="space-y-20 md:space-y-32 pb-20 md:pb-32">
                ...
                <section className="px-4 md:px-20 max-w-7xl mx-auto w-full">
                    <div className="section-header mb-10 md:mb-16">
                        <span className="text-[#4CBBD5] text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase block mb-3 md:mb-4">01. INSTITUTIONS</span>
                        <h3 className="text-3xl md:text-5xl font-light">Soutien Public</h3>
                            ...
                            >
                                <div className="flex flex-col md:flex-row md:items-center justify-between relative z-10 gap-2 md:gap-4">
                                    <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-6">
                                        <span className="font-mono text-[10px] md:text-xs text-[#4CBBD5] w-24">{inst.category}</span>
                                        <h3 className="text-2xl md:text-4xl font-light group-hover:text-white transition-colors text-white/80">
                                            {inst.name}
                                        </h3>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 md:-translate-x-4 md:group-hover:translate-x-0">
                                        <span className="text-xs md:text-sm text-white/60 text-right hidden md:block">{inst.details}</span>
                                        <div className="px-2 py-1 md:px-3 md:py-1 rounded-full border border-[#4CBBD5]/30 bg-[#4CBBD5]/10 text-[#4CBBD5] text-[10px] md:text-xs font-bold whitespace-nowrap w-fit">
                                            {inst.role}
                                        </div>
                                    </div>
                                </div>
                ...
                <section className="px-4 md:px-6 relative">
                    ...
                    <div className="max-w-7xl mx-auto py-10">
                        <div className="section-header text-center mb-12 md:mb-20 flex flex-col items-center">
                            <span className="text-[#4CBBD5] text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase block mb-3 md:mb-4">02. SCIENCES</span>
                            <h3 className="text-3xl md:text-5xl font-light">Excellence Scientifique</h3>
                            <div className="h-1 w-16 md:w-24 bg-gradient-to-r from-[#4CBBD5] to-transparent mt-3 md:mt-4" />
                            <p className="text-white/60 mt-4 md:mt-6 max-w-2xl mx-auto text-sm md:text-lg italic">&quot;Un écosystème de recherche complet, des abysses à la surface&quot;</p>
                        </div>

                        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                            {/* Ifremer */}
                            <div className="hex-item w-64 h-72 md:w-72 md:h-80 relative group">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-8 z-10">
                                    <FlaskConical className="w-10 h-10 md:w-12 md:h-12 text-[#4CBBD5] mb-4 md:mb-6 group-hover:scale-110 transition-transform" />
                                    <h4 className="text-xl md:text-2xl font-bold mb-2">Ifremer</h4>
                                    <div className="w-8 h-1 bg-[#4CBBD5] mb-3 md:mb-4" />
                                    <p className="text-xs md:text-sm text-white/80">Expertise Océanique</p>
                                    <p className="text-[10px] md:text-xs text-white/50 mt-2">&quot;Des abysses à la surface&quot;</p>
                                </div>
                            </div>

                            {/* Université */}
                            <div className="hex-item w-64 h-72 md:w-72 md:h-80 relative group mt-0 md:mt-24">
                                <div className="absolute inset-0 bg-[#006994]/20 clip-hex backdrop-blur-sm border-2 border-[#4CBBD5]/30 group-hover:bg-[#4CBBD5]/20 transition-colors duration-500" />
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-8 z-10">
                                    <Microscope className="w-10 h-10 md:w-12 md:h-12 text-[#4CBBD5] mb-4 md:mb-6 group-hover:scale-110 transition-transform" />
                                    <h4 className="text-xl md:text-2xl font-bold mb-2">Université</h4>
                                    <div className="w-8 h-1 bg-[#4CBBD5] mb-3 md:mb-4" />
                                    <p className="text-xs md:text-sm text-white/80">Recherche & Formation</p>
                                    <p className="text-[10px] md:text-xs text-white/50 mt-2">SeaTech & Ingénierie</p>
                                </div>
                            </div>
                            ...
                            <div className="hex-item w-64 h-72 md:w-72 md:h-80 relative group">
                                <div className="absolute inset-0 bg-[#006994]/20 clip-hex backdrop-blur-sm border-2 border-[#4CBBD5]/30 group-hover:bg-[#4CBBD5]/20 transition-colors duration-500" />
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-8 z-10">
                                    <Atom className="w-10 h-10 md:w-12 md:h-12 text-[#4CBBD5] mb-4 md:mb-6 group-hover:scale-110 transition-transform" />
                                    <h4 className="text-xl md:text-2xl font-bold mb-2">CNRS</h4>
                                    <div className="w-8 h-1 bg-[#4CBBD5] mb-3 md:mb-4" />
                                    <p className="text-xs md:text-sm text-white/80">Laboratoires</p>
                                    <p className="text-[10px] md:text-xs text-white/50 mt-2">Excellence Nationale</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="blueprint-section px-4 md:px-20 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:40px_40px]" />

                    <div className="max-w-7xl mx-auto">
                        <div className="section-header mb-8 md:mb-12 relative z-10">
                            <span className="text-[#4CBBD5] text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase block mb-3 md:mb-4">03. INDUSTRIE</span>
                            <h3 className="text-3xl md:text-5xl font-light">Leaders Technologiques</h3>
                            <div className="h-1 w-16 md:w-24 bg-gradient-to-r from-[#4CBBD5] to-transparent mt-3 md:mt-4" />
                        </div>
                        ...
                        <div className="relative z-10 border border-[#4CBBD5]/30 bg-[#020A19]/90 backdrop-blur-md p-6 md:p-12">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
                                {/* Main Partner */}
                                <div className="lg:col-span-2 border-r-0 lg:border-r border-white/10 pr-0 lg:pr-12">
                                    <div className="flex items-center justify-between mb-4 md:mb-6">
                                        <span className="text-[#4CBBD5] font-mono text-[10px] md:text-xs">PARTENAIRE MAJEUR</span>
                                        <Ship className="text-[#4CBBD5] w-5 h-5 md:w-6 md:h-6" />
                                    </div>
                                    <h3 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">NAVAL GROUP</h3>
                                    <div className="h-px w-full bg-[#4CBBD5]/30 mb-4 md:mb-6 blueprint-line" />
                                    <p className="text-sm md:text-lg text-white/80 leading-relaxed mb-4 md:mb-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="bg-[#4CBBD5]/5 p-3 border-l-2 border-[#4CBBD5]">
                                            <span className="block text-[10px] md:text-xs text-[#4CBBD5] font-bold">DOMAINE</span>
                                            <span className="text-xs md:text-sm">Défense Navale</span>
                                        </div>
                                        <div className="bg-[#4CBBD5]/5 p-3 border-l-2 border-[#4CBBD5]">
                                            <span className="block text-[10px] md:text-xs text-[#4CBBD5] font-bold">IMPLANTATION</span>
                                            <span className="text-xs md:text-sm">Toulon (Historique)</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4 md:space-y-6">
                                    <span className="text-[#4CBBD5] font-mono text-[10px] md:text-xs block mb-3 md:mb-4">ÉCOSYSTÈME INDUSTRIEL</span>
                                    ...
                                    <div className="group border border-white/10 p-4 hover:border-[#4CBBD5] transition-colors cursor-default">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <h5 className="font-bold text-sm md:text-base">Pôle Mer Méditerranée</h5>
                                        </div>
                                        <p className="text-[10px] md:text-xs text-white/60">Cluster d&apos;innovation maritime et économie bleue</p>
                                    </div>

                                    <div className="group border border-white/10 p-4 hover:border-[#4CBBD5] transition-colors cursor-default">
                                        <div className="flex items-center gap-3 mb-2">
                                            <Radio className="w-5 h-5 text-[#4CBBD5]" />
                                            <h5 className="font-bold text-sm md:text-base">ECA Group</h5>
                                        </div>
                                        <p className="text-[10px] md:text-xs text-white/60">Leader en robotique et drones sous-marins</p>
                                    </div>

                                    <div className="group border border-white/10 p-4 hover:border-[#4CBBD5] transition-colors cursor-default">
                                        <div className="flex items-center gap-3 mb-2">
                                            <div className="text-[#4CBBD5] font-bold">●</div>
                                            <h5 className="font-bold text-sm md:text-base">Orange Marine</h5>
                                        </div>
                                        <p className="text-[10px] md:text-xs text-white/60">Expert mondial des câbles sous-marins</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="px-4 md:px-20 max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className="flex justify-center lg:justify-end order-2 lg:order-1">
                            <div className="relative w-[280px] h-[280px] md:w-[400px] md:h-[400px]">
                                ...
                                <div className="absolute inset-[45%] rounded-full bg-[#4CBBD5]/10 backdrop-blur-md flex items-center justify-center z-20 shadow-[0_0_30px_rgba(76,187,213,0.2)]">
                                    <Anchor className="w-12 h-12 md:w-16 md:h-16 text-[#4CBBD5]" />
                                </div>
                                ...
                                {/* Orbiting Items */}
                                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#020A19] px-3 py-1 md:px-4 md:py-2 border border-[#4CBBD5] rounded-full z-30 shadow-lg">
                                    <span className="text-[#4CBBD5] font-bold text-xs md:text-sm tracking-wider">MARINE NATIONALE</span>
                                </div>

                                <div className="absolute bottom-[20%] right-[5%] text-right z-30 bg-[#020A19]/80 backdrop-blur px-2 py-1 md:px-3 md:py-1 rounded border border-white/10">
                                    <h5 className="text-white font-bold text-xs md:text-sm">CEPHISMER</h5>
                                    <p className="text-[10px] text-[#4CBBD5]">Plongée Humaine</p>
                                </div>

                                <div className="absolute top-[30%] left-[0%] z-30 bg-[#020A19]/80 backdrop-blur px-2 py-1 md:px-3 md:py-1 rounded border border-white/10">
                                    <h5 className="text-white font-bold text-xs md:text-sm">SNA</h5>
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="section-header mb-6 md:mb-8">
                                <span className="text-[#4CBBD5] text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase block mb-3 md:mb-4">04. DÉFENSE</span>
                                <h3 className="text-3xl md:text-5xl font-light">Partenaire Stratégique</h3>
                                <div className="h-1 w-16 md:w-24 bg-gradient-to-r from-[#4CBBD5] to-transparent mt-3 md:mt-4" />
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h5 className="font-bold text-white text-sm md:text-base">Expertise Opérationnelle</h5>
                                        <p className="text-xs md:text-sm text-white/60">Lien direct avec les unités d&apos;intervention sous-marine.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-2 h-2 mt-2 rounded-full bg-[#4CBBD5]" />
                                    <div>
                                        <h5 className="font-bold text-white text-sm md:text-base">Patrimoine Unique</h5>
                                        <p className="text-xs md:text-sm text-white/60">Valorisation de l&apos;histoire des sous-marins nucléaires.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative p-8 md:p-16 rounded-3xl bg-[#020A19] border border-[#4CBBD5]/30 overflow-hidden text-center group hover:border-[#4CBBD5]/60 transition-all duration-500">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 md:mb-8 bg-[#4CBBD5]/10 rounded-2xl flex items-center justify-center border border-[#4CBBD5]/20 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_20px_rgba(76,187,213,0.1)]">
                                <Mail className="w-6 h-6 md:w-8 md:h-8 text-[#4CBBD5]" strokeWidth={1.5} />
                            </div>

                            <h3 className="text-3xl md:text-5xl font-light mb-4 md:mb-6 text-white">Rejoignez l&apos;Aventure</h3>
                            <p className="text-base md:text-xl text-white/60 mb-8 md:mb-10 leading-relaxed">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-3 bg-white text-[#020A19] px-8 py-3 md:px-10 md:py-4 rounded-full font-bold tracking-widest uppercase hover:bg-[#4CBBD5] hover:text-white transition-all duration-300 shadow-lg hover:shadow-[0_0_30px_rgba(76,187,213,0.4)] text-sm md:text-base"
                            >
                                <Mail className="w-4 h-4 md:w-5 md:h-5" />
                                <span>Nous Contacter</span>
                            </a>
                            <p className="text-[#4CBBD5] text-xs md:text-sm mt-6 md:mt-8 font-mono tracking-wider opacity-80">
