...
export default function ExpositionsPage() {
    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-[#020A19] text-white selection:bg-[#4CBBD5] selection:text-[#020A19] overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-6 z-10 pt-20">
                ...
                <div className="relative z-10 space-y-10 max-w-5xl mx-auto">
                    <div className="hero-badge inline-flex items-center gap-2 px-6 py-3 bg-[#4CBBD5]/10 border border-[#4CBBD5]/30 rounded-full backdrop-blur-sm">
                        <div className="w-2 h-2 rounded-full bg-[#4CBBD5] animate-pulse" />
                        <span className="text-[#4CBBD5] text-xs md:text-sm font-bold tracking-[0.3em] uppercase">
                            Parcours & Collections
                        </span>
                    </div>

                    <h1 className="hero-title text-6xl md:text-8xl lg:text-9xl font-light tracking-tighter text-white leading-[0.9]">
                        VOYAGE<br />
                        <span className="font-serif italic text-white/80">ABYSSAL</span>
                    </h1>

                    <div className="hero-subtitle flex flex-col items-center gap-8">
                        <div className="h-16 w-px bg-gradient-to-b from-[#4CBBD5] to-transparent" />
            ...
            <div className="space-y-32 pb-32 relative z-10">
                ...
                {/* ZONE 1: LA GRANDE HALLE DES ENGINS (Redesigned - Compact Hangar) */}
                <section className="px-6 md:px-12 max-w-[1400px] mx-auto w-full relative">
                    {/* Hangar Background */}
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-start">
                        ...
                        <div className="lg:w-1/3 sticky top-32">
                            <div className="section-header mb-10">
                                <span className="text-[#4CBBD5] text-xs font-bold tracking-[0.3em] uppercase block mb-4">01. GRANDE HALLE</span>
                                <h3 className="text-4xl md:text-5xl font-light uppercase">Génie Naval</h3>
                                <div className="h-1 w-24 bg-gradient-to-r from-[#4CBBD5] to-transparent mt-4" />
                                <p className="mt-6 text-white/60 text-base leading-relaxed border-l-2 border-[#4CBBD5]/30 pl-6">
                            ...
                            <div className="group cursor-pointer border border-[#4CBBD5]/30 bg-[#4CBBD5]/5 p-5 hover:bg-[#4CBBD5]/10 transition-all duration-300 rounded-lg">
                                <div className="flex items-center justify-between mb-3">
                                    <span className="text-[#4CBBD5] text-[10px] font-bold tracking-widest uppercase">Simulation</span>
                                    <Navigation className="w-4 h-4 text-[#4CBBD5]" />
                                </div>
                                <h4 className="text-xl font-bold mb-2">PILOTE D&apos;ÉLITE</h4>
                        ...
                        {/* Right: The Exhibits (Compact Vertical Layout) */}
                        <div className="lg:w-2/3 space-y-4">
                            {techItems.map((item, i) => (
                                <div key={i} className="group relative bg-[#020A19] border border-white/10 hover:border-[#4CBBD5] transition-all duration-500 p-4 md:p-6 flex flex-col md:flex-row gap-6 items-center rounded-xl overflow-hidden">
                                    ...
                                    {/* Tech Visual */}
                                    <div className="w-full md:w-24 aspect-square bg-[#4CBBD5]/5 rounded-full flex items-center justify-center relative overflow-hidden group-hover:scale-105 transition-transform duration-500 shrink-0">
                                        <div className="absolute inset-0 border border-[#4CBBD5]/20 rounded-full border-dashed animate-[spin_20s_linear_infinite]" />
                                        <item.icon className="w-8 h-8 text-[#4CBBD5]" strokeWidth={1.5} />
                                    </div>

                                    {/* Tech Specs */}
                                    <div className="flex-1 relative z-10">
                                        <div className="flex items-center gap-3 mb-1">
                                            <span className="font-mono text-xl font-bold text-white/20 group-hover:text-[#4CBBD5]/40 transition-colors">0{i + 1}</span>
                                            <span className="font-mono text-[#4CBBD5] text-[10px] border border-[#4CBBD5]/30 px-1.5 py-0.5 rounded">{item.year}</span>
                                        </div>
                                        <h4 className="text-xl font-bold mb-1 group-hover:text-[#4CBBD5] transition-colors">{item.name}</h4>
                ...
                {/* ZONE 2: BIODIVERSITÉ & ABYSSES (Enhanced Design) */}
                <section className="px-6 md:px-20 max-w-7xl mx-auto w-full relative">
                    <div className="section-header mb-16 relative z-10 text-right">
                        <span className="text-[#4CBBD5] text-xs font-bold tracking-[0.3em] uppercase block mb-4">02. BIODIVERSITÉ</span>
                        <h3 className="text-4xl md:text-5xl font-light uppercase">La Vie dans le Noir</h3>
                        <div className="h-1 w-24 bg-gradient-to-l from-[#4CBBD5] to-transparent mt-4 ml-auto" />
                        <p className="mt-6 text-white/60 max-w-xl ml-auto leading-relaxed">
                        ...
                        {[
                            ...
                            <div key={i} className="group relative rounded-2xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 h-full shadow-2xl">
                                ...
                                <div className="p-8 relative z-10 h-full flex flex-col">
                                    <div className="w-12 h-12 bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-xl flex items-center justify-center mb-6 group-hover:border-[#4CBBD5]/50 group-hover:shadow-[0_0_15px_rgba(76,187,213,0.3)] transition-all duration-500">
                                        <card.icon className="w-6 h-6 text-white group-hover:text-[#4CBBD5] transition-colors" />
                                    </div>
                                    <h3 className="text-xl font-bold mb-4 leading-tight group-hover:text-[#4CBBD5] transition-colors">{card.title}</h3>
                                    <p className="text-white/60 text-sm leading-relaxed mb-6 flex-1 border-t border-white/5 pt-4">
                                        {card.desc}
                                    </p>
                                    <div className="flex items-center gap-2 text-[#4CBBD5] text-xs font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
                                        <span>Explorer</span>
                ...
                {/* ZONE 3: GÉOPOLITIQUE & STRATÉGIE (Cleaned Up) */}
                <section className="w-full bg-[#020A19] relative overflow-hidden py-24 border-y border-[#4CBBD5]/10">
                    {/* Radar Background - Contained */}
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-10 overflow-hidden">
                        <div className="w-[800px] h-[800px] border border-[#4CBBD5] rounded-full absolute radar-scan" />
                        <div className="w-[600px] h-[600px] border border-[#4CBBD5] rounded-full absolute" />
                        <div className="w-[400px] h-[400px] border border-[#4CBBD5] rounded-full absolute" />
                    ...
                    <div className="px-6 md:px-20 max-w-7xl mx-auto relative z-10">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                            <div className="section-header">
                                <span className="text-[#4CBBD5] text-xs font-bold tracking-[0.3em] uppercase block mb-4">03. SOUVERAINETÉ</span>
                                <h3 className="text-4xl md:text-5xl font-light uppercase">Espions des Océans</h3>
                                <div className="h-1 w-24 bg-gradient-to-r from-[#4CBBD5] to-transparent mt-4" />
                            </div>
                            <div className="text-right">
                                <div className="text-5xl font-mono font-bold text-[#4CBBD5] mb-1">9.5 M</div>
                                <div className="text-xs text-white/50 uppercase tracking-wider">km² de ZEE Française</div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={i} className={`bg-[#020A19]/90 backdrop-blur border p-6 transition-all duration-300 group relative overflow-hidden rounded-lg ${card.alert ? 'border-red-500/30 hover:border-red-500' : 'border-white/10 hover:border-[#4CBBD5]'}`}>
                                    <div className={`absolute top-0 right-0 px-2 py-1 text-[10px] font-bold uppercase rounded-bl-lg ${card.alert ? 'bg-red-500/20 text-red-500' : 'bg-[#4CBBD5]/10 text-[#4CBBD5]'}`}>
                                        {card.status}
                                    </div>
                                    <card.icon className={`w-8 h-8 mb-6 ${card.alert ? 'text-red-500' : 'text-[#4CBBD5]'}`} />
                                    <h4 className="font-bold text-xl mb-3">{card.title}</h4>
                                    <p className="text-white/60 text-sm leading-relaxed mb-4">{card.desc}</p>

                                    {/* Removed confusing half-line, replaced with full subtle border */}
                ...
                {/* ZONE 4: L'HISTOIRE À TOULON (Aligned Header & Visible Years) */}
                <section className="px-6 md:px-20 max-w-7xl mx-auto w-full">
                    <div className="section-header mb-24 flex flex-col items-start text-left">
                        <span className="text-[#4CBBD5] text-xs font-bold tracking-[0.3em] uppercase block mb-4">04. ANCRAGE TERRITORIAL</span>
                        <h3 className="text-4xl md:text-5xl font-light uppercase">Toulon, Terre de Pionniers</h3>
                        <div className="h-1 w-24 bg-gradient-to-r from-[#4CBBD5] to-transparent mt-4" />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-24">
                            {[
                                ...
                                <div key={i} className="timeline-item relative flex flex-col md:grid md:grid-cols-2 md:gap-20 items-center">
                                    {/* Dot */}
                                    <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-[#020A19] border-2 border-[#4CBBD5] rounded-full md:-translate-x-1/2 ml-[1.15rem] md:ml-0 z-10" />

                                    {/* Date (Alternating) - Increased Opacity */}
                                    <div className={`pl-16 md:pl-0 w-full ${i % 2 === 0 ? 'md:text-right md:pr-0' : 'md:order-2 md:text-left'}`}>
                                        <span className="text-6xl md:text-8xl font-serif font-bold text-white/20 block leading-none mb-2 md:mb-0">{item.year}</span>
                                    </div>

                                    {/* Content (Alternating) */}
                                    <div className={`pl-16 md:pl-0 w-full ${i % 2 === 0 ? 'md:text-left' : 'md:order-1 md:text-right'}`}>
                                        <h3 className="text-3xl font-bold mb-3 text-[#4CBBD5]">{item.title}</h3>
